import { Box, Button, Container, FormControl, HStack, Input, Stack, Text } from "@chakra-ui/react";
    ...
    return (
        <Container maxW="xl">
                ...
                <Stack spacing={5} my={5}>
                    ...
                    <HStack spacing="10px" color="black">
                        <FormControl id="email" isRequired>
                            <Text fontSize='xs' color='white'>Email</Text>
                            <Input value={email} placeholder='Enter your email'
                                onChange={(e) => setEmail(e.target.value)}
                                _placeholder={{ opacity: 1, color: 'white' }} color='white' />
                        </FormControl>
                        <FormControl id="number" isRequired>
                            <Text fontSize='xs' color='white'>Phone number</Text>
                            <Input value={number} placeholder='Enter your phone number'
            ...
            <Stack spacing={5} direction='row' mt='3'>
                ...
                <Button colorScheme='teal' color='white' mt='2' onClick={onCreateAccount}>Create Account</Button>
            </Stack>
        </Container >
    )
}
